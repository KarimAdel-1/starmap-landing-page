export default function MobileMenuToggle({ isOpen, onClick }) {
  return (
    <button
      ...
      className="relative text-stone-950/30 text-[13.3333px] items-center bg-stone-50 caret-transparent block h-[42px] justify-center leading-[normal] min-h-[auto] min-w-[auto] order-3 text-center w-[42px] rounded-xl font-arial md:hidden md:min-h-0 md:min-w-0"
    >
