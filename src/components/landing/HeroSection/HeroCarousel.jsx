  ...
  return (
    <>
      ...
      <div className="relative box-border caret-transparent z-[11] flex flex-col h-full">
        ...
        <div className="items-center box-border caret-transparent flex flex-col md:flex-row justify-center gap-4 mt-[30px]">
          ...
          <a href="/create" className="text-white text-[13.3333px] items-center bg-transparent caret-transparent inline-flex leading-[normal] text-center border border-white px-4 py-3 rounded-lg border-solid font-arial">
            <div className="box-border caret-transparent">
              <div className="text-sm font-bold items-center box-border caret-transparent flex justify-center tracking-[-0.28px] leading-[14px] text-nowrap font-degular">
                Customize Now
                <div className="items-center aspect-square bg-white box-border caret-transparent flex justify-center text-nowrap w-[18px] ml-2 rounded-md">
                  <IoChevronForward className="text-stone-800" />
                </div>
              </div>
            </div>
